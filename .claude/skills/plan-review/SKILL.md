...
- The plan involves writing or changing code.
- The plan touches more than one file OR introduces a new abstraction (function, class, type, module, config key, route, schema field, table, env var).
