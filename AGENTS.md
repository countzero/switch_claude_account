...
- **Changelog** follows [Common Changelog](https://common-changelog.org) with four deliberate deviations, each recorded with its reason in `docs/conventions.md` → *Changelog*. Edit `CHANGELOG.md` only as a step of a release.
